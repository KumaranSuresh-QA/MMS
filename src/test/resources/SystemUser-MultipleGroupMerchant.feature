...
Scenario: SystemMaker Login
 ...
 And I enter the credentials and click a login button in Regression using sheetname "Credentials" and rownumber 1
   ...
   Scenario: System Maker sees Onboarding in Sidemenu in Group Merchant Onboarding
    When System Maker - Onboarding should be displayed in the side menu

  Scenario: System Maker sees side menu items in Group Merchant Onboarding
  ...
  Scenario: System Maker clicks the Group Merchant module
 ...
 #Scenario: System Verifier sees Onboarding in Sidemenu in SUB ISO Onboarding
   #When System Verifier - Onboarding should be displayed in the side menu
    #
#
#Scenario: System Verifier sees side menu items in Group Merchant Onboarding
...
#
 #Scenario: System Verifier clicks the Group Merchant module
    ...
    #
    #
#Scenario: System Verifier Successfully Verifies All Steps in Group Merchant Onboarding
#When the System Verifier completes Group Merchant Onboarding, the system should prompt to verify all steps using the sheet name "Group Merchant Regression"
 #
 #
...
#Scenario: System Approver Successfully Approve in SUB ISO Onboarding
    #When the System Approver completes Group Merchant Onboarding, the system should prompt to Approve using the sheet name "Group Merchant Regression"
